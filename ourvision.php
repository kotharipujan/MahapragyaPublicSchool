...
<div class="container-fluid">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-9 " >
      <h3 style="margin-top:30px;margin-bottom:50px;margin-left: 3vw;font-size: 40px;text-align: center">
      	Mission Statement
      </h3>     
<div id="text"style="margin-left: 3vw;">

<p style="text-align: center;font-size:22px;font-weight: bold">Inspired By Acharya Tulsiji words,"Jain Bano na bano, Good Man bano"</p>

<p style="font-size: 22px;color: red;text-align: center">We, at Mahpragya Public School, Kalbadevi, Mumbai, march forward wit enthusiasm to create positive minded young indiviuals, with all-rund development through Jeevan Vigyan, while properlling them to asipre to excel in scholarstic and co-scholatistic displinces, in a positive atmosphere of learning.</p>
<br>

<p style="font-size: 22px;">
<font>Immediate Goals:</font>
<br>
<ul style="font-size: 20px;">
a. Empowering Teachers to create a positive atmsphere conductive for teaching and learning.</ul>
</ul>
<ul style="font-size: 20px;">
b. Reduction in the weight of school bag.
</ul>
<ul style="font-size: 20px;">
c. Improvement in the standard of english communicative skills of students.
</ul>
<ul style="font-size: 20px;">
  d. Improvement in Science and Mathematics activities.
</ul>
<ul style="font-size: 20px;">
 e. More co-scholastic activites for the students.
</ul>
