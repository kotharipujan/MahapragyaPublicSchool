...
while ($item = mysqli_fetch_array($query1))
{
    ...
    echo '<td>' . $item['tpos'] . '</td>';

    echo '<td>' . $item['tmessage'] . '</td>';

    echo '<td>' . $item['sname'] . '</td>';

    echo '<td>' . $item['sclass'] . '</td>';

    echo '<td>' . $item['smessage'] . '</td>';


    echo '<td><a href="deletetestimony.php?id='.$item['id'].'">Delete</a></td>';
    echo '<td><a href="addtestimony.php">add</a></td>';
